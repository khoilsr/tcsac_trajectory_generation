...
////###############################################################################################################
    ...
    input_file.open("data/result_Liss.txt");
    param_file.open("data/params_Liss.txt");
    ...
    cost_params.obstacle_x.push_back(43);
    ...
    cost_params.obstacle_y.push_back(-50);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(48);
    cost_params.obstacle_y.push_back(47);
    cost_params.obstacle_r.push_back(2);
