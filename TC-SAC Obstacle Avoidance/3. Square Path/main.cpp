...
////###############################################################################################################
    ...
    cost_params.Q1_control.push_back(0*pow(10,-5)); //2 M
        ...
        cost_params.P1.push_back(0*pow(10,1)); //5
    ...
    cost_params.obstacle_x.push_back(50);
    cost_params.obstacle_y.push_back(0);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(100);
    cost_params.obstacle_y.push_back(0);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(150);
    cost_params.obstacle_y.push_back(0);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(200);
    cost_params.obstacle_y.push_back(0);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(250);
    cost_params.obstacle_y.push_back(125);
    cost_params.obstacle_r.push_back(2);

    cost_params.obstacle_x.push_back(50);
    cost_params.obstacle_y.push_back(250);
    cost_params.obstacle_r.push_back(2);
    ...
    cost_params.obstacle_x.push_back(0);
    cost_params.obstacle_y.push_back(125);
    cost_params.obstacle_r.push_back(2);
