...
data05=load('result_Circle05.txt');
...
for i=1:size(t05)+50
x_t05(i,1)=50*sin(2*pi*0.031830988618379*t05(2)*(i-1));
y_t05(i,1)=50*cos(2*pi*0.031830988618379*t05(2)*(i-1));
end
for i=1:size(t05)
...
data10=load('result_Circle10.txt');
...
for i=1:size(t10)+50
x_t10(i,1)=50*sin(2*pi*0.031830988618379*t10(2)*(i-1));
y_t10(i,1)=50*cos(2*pi*0.031830988618379*t10(2)*(i-1));
end
for i=1:size(t10)
...
data30=load('result_Circle30.txt');
...
for i=1:size(t30)+50
x_t30(i,1)=50*sin(2*pi*0.031830988618379*t30(2)*(i-1));
y_t30(i,1)=50*cos(2*pi*0.031830988618379*t30(2)*(i-1));
end
for i=1:size(t30)
